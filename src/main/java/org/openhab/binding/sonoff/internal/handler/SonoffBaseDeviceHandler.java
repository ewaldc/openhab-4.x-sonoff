 ...
 */
@NonNullByDefault
public abstract class SonoffBaseDeviceHandler extends BaseThingHandler implements SonoffDeviceListener {

    private final Logger logger = LoggerFactory.getLogger(SonoffBaseDeviceHandler.class);
    ...
    public SonoffBaseDeviceHandler(Thing thing) {
        super(thing);
    }
